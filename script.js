// Game State
        ...
        document.getElementById('startGame').addEventListener('click', () => {
            ...
            // Set character icon — use the selected card's image src (fallback to previous SVGs if not found)
            (function(){
                const selectedCard = document.querySelector('.character-card.selected');
                let imgSrc = selectedCard ? (selectedCard.querySelector('.character-icon')?.getAttribute('src') || '') : '';
